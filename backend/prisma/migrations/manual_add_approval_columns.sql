-- Manual migration to add approval workflow columns to exports table
-- Run this if Prisma migrate detects drift
...
-- Create report_approval_history table if it doesn't exist
...
-- Add metaJson to org_settings if it doesn't exist
